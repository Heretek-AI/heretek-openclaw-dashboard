...
2. **Clone your fork** locally
   ```bash
   git clone https://github.com/your-username/heretek-openclaw-dashboard.git
   cd heretek-openclaw-dashboard
   ```
3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/heretek/heretek-openclaw-dashboard.git
   ```
